...
export class CategoryService {
  private url = Config.urlApiRes() + '/nomenclator/category';

  private functionality = 'NCATEGORY';
  ...
  new(category: Category): Observable<any> {
  ...
  update(category: Category, id: string): Observable<any> {
    let params = new HttpParams();
    params = params.append('id', id);
    ...
    return this.http.put(`${this.url}`, category, options)
      .pipe( map(r => r),
